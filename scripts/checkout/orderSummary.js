  ...
  `;
	...
	function deliveryOptionsHTML(matchingProduct, cartItem) {
      ...
      <div class="delivery-option js-delivery-option" 
        ...
        <input type="radio"
          ...
          name="${matchingProduct.id}" ${isChecked ? 'checked' : ''}>
        <div>
	...
	document.querySelectorAll('.js-delete-link').forEach((deleteLink) => {
		deleteLink.addEventListener('click', () => {
			...
			const removeContainer = document.querySelector(`.js-delete-${productId}`);
	...
	document.querySelectorAll('.js-update-link').forEach((updateLink) => {
		updateLink.addEventListener('click', () => {
			...
			const update = document.querySelector(`.js-delete-${productId}`);
			if (update) {
	...
	document.querySelectorAll('.js-delivery-option').forEach((dateElement) => {
		dateElement.addEventListener('click', () => {
			const { productId, deliveryOptionId } = dateElement.dataset;
